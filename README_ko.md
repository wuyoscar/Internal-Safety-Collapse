...
<p>
  <strong><font color="#f97316">주요 조정 예시:</font></strong>
</p>
<ul>
  <li><font color="#f97316">전체 conversation link를 스크린샷으로 대체했습니다.</font></li>
  <li><font color="#f97316">생물, 화학, 유전자 조작, 코드 취약점, shellcode 관련 내용을 제거했습니다.</font></li>
  <li><font color="#f97316">극단적 예시와 trigger를 제거하고, 각 template에는 최대 두 개의 완화된 TVD만 남겼습니다.</font></li>
  <li><font color="#f97316">Skill, tutorial, Jupyter Notebook을 제거하고, MD 파일에는 description만 남겼습니다.</font></li>
  <li><font color="#f97316">Misinformation 예시는 유지했습니다.</font></li>
</ul>
