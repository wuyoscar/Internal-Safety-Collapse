...
<p>
  <strong><font color="#f97316">主な変更例：</font></strong>
</p>
<ul>
  <li><font color="#f97316">完全な conversation link をスクリーンショットに置き換えました。</font></li>
  <li><font color="#f97316">生物、化学、遺伝子改変、コード脆弱性、shellcode 関連の内容を削除しました。</font></li>
  <li><font color="#f97316">極端な例と trigger を削除し、各 template には最大二つの穏当な TVD のみ残しました。</font></li>
  <li><font color="#f97316">Skill、tutorial、Jupyter Notebook を削除し、MD ファイルには description のみ残しました。</font></li>
  <li><font color="#f97316">Misinformation の例は残しています。</font></li>
</ul>
