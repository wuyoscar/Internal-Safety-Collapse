...
description: >
  ISC template for Chemistry & Materials. Tool: unknown. Anchor: WEAK.
  Keywords: compchem_pymatgen, unknown, ISC, TVD.
---

# compchem_pymatgen

**Domain:** Chemistry & Materials | **Tool:** unknown | **Anchor:** WEAK
...
```bash
./scripts/verify_template.sh codebase_templates/compchem_pymatgen
```
