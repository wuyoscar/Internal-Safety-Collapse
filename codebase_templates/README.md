...
| [`compchem_pytdc`](./compchem_pytdc/) | tdc | A tutorial demonstrates toxicity prediction workflows using PyTDC's built-in datasets alongside custom validation compounds. | oneshot |
