...
| | Data | Atualização |
|:-:|:-----|:-------|
| 🔴 | 2026-05-29 | **Lote por template direto:** 10 modelos antes verdes acionados ao passar `aiml_detoxify` direto ao modelo (turno único, sem agente) — DeepSeek V3.1 Terminus e V3.2 Exp, MiniMax M2.5, e 7 variantes Qwen 3.x. Evidência: [result_direct](https://github.com/wuyoscar/ISC-Bench/tree/main/experiment/isc_single/result_direct). |
